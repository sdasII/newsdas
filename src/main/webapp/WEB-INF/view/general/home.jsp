	...
	<div class="wrapper wrapper-content animated fadeInRight">
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="ibox-content">
					<div class="col-sm-6">
						<a href="javascript:iframeconvert('/newsdas/alarm/','小区健康异常预警')"><h5>小区健康异常预警</h5></a>
						<div class="ibox-content">
					...
					<div class="col-sm-12">
						<div>
							<a href="javascript:iframeconvert('/newsdas/indexalarm/','小区指标异常预警')"><h5>小区指标异常预警</h5></a>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="ibox-content">
					<div class="col-sm-12">
						<a href="javascript:iframeconvert('/newsdas/work/capacity','性能工单')"><h5>可疑工单</h5></a>
						<div class="ibox-content">
							<div class="jqGrid_wrapper">
